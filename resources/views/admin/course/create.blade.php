                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type="checkbox" class="form-control" name="weekDays[]" value="Sun">الأحد</label>
                                <label><input type="checkbox" class="form-control" name="weekDays[]" value="Mon">الأثنين</label>
                                <label><input type="checkbox" class="form-control" name="weekDays[]" value="Tue">الثلاثاء</label>
                                <label><input type="checkbox" class="form-control" name="weekDays[]" value="Wed">الأربعاء</label>
                                <label><input type="checkbox" class="form-control" name="weekDays[]" value="Thu">الخميس</label>
                                <label><input type="checkbox" class="form-control" name="weekDays[]" value="Fri">الجمعة</label>
                            </td>
                        </tr>
						...
						<tr>
                    		<td>وسيلة التقديم</td>
                    		<td>
								<select name="deliveryMeans" class="form-control">
									<option value="googlemeeting">googlemeeting</option>
									<option value="zoom">zoom</option>
									<option value="whatsapp">whatsapp</option>
                                    <option value="youtube">youtube</option>
									<option value="youtube">الحضور إلى المركز</option>
								</select>
							</td>
                    	</tr>
                    	<tr>
